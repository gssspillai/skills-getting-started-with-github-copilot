...
activities = {
    ...
    "Tennis Club": {
        "description": "Practice tennis skills and participate in matches",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 10,
        "participants": []
    },
    "Volleyball Team": {
        "description": "Train for volleyball games and improve teamwork",
    ...
    "Dance Club": {
        "description": "Explore different dance styles and choreograph routines",
